...
LinkedFlow es una aplicación autoalojada para generar y gestionar interacción en LinkedIn con **IA local** 🤖. El backend está construido con **NestJS** y el frontend con **React + TypeScript**, de forma que puedes crear comentarios, analizar contenido y operar toda la plataforma sin enviar datos a servicios externos.
